...
```{r}
scatterplotMatrix( ~ t_sub3$Household.penetration..OECD + 
                       t_sub3$Price.for.very.high.speeds..combined + 
                       t_sub3$Price.for.high.speeds..combined + 
                       t_sub3$Price.for.med.speeds..combined + 
                       t_sub3$Price.for.low.speeds..combined, 
                   diagonal = 'hist',
