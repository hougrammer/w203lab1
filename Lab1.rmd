...
On average, the average actual speed is 3490.04. For every percent increase in the population, the average speed increase by 5.096. 
...
On average, the actual speed for very high speed price is 5164.18  The average speed for high speed price is 4219.80.
The average speed for medium speed is 6065.74. This speed is higher than the very high speed internet and the high speed internet.
The average speed for low speed price is 5126.6. Again, the average speed is higher than high speed internet.
...
The average speed for very high speed internet price is 5174.53. For every dollar less the consumers paid, the speed reduced by 12.30. For every percent increase in the urban population, the speed reduced by 0.14.
...
The average speed for high speed internet is 3793.12. For every dollar less the consumers paid, the speed reduced by 7.28. For every percent increase in the urban population, the speed suprisingly increase by 5.69. This result suggested the types of internet (e.g. cable vs DSL) might be used in the internet infrastructure. Similar result occured in the medium and low priced internet. 
...
The average speed for medium speed internet is 4682.40. For every dollar less the consumers paid, the speed reduce by 66.77. For every percent increase in the urban population, the speed increase by 21.77.
...
```
The average speed for low speed internet is 2987.39. For every dollar less the consumers paid for the internet, the average speed reduce by 54.57. For every percent increase in the urban population, the speed increase by 14.93.
...
To examine the claim that attempts to regulate prices or mandate greater penetration will reduce incentives for ISP's to invest in non-rural areas, we examined the relationship between price and urban population as a secondary effect. As expected, the population percentage in urban areas also played a role in how fast internet speed was. The more consumers in the urban area, the slower the very high speed internet speed is. In addition, we found a positive relationship between urban population % and prices: countries with higher population in urban areas showed higher prices. 

The faster speed in the slower speed internet price potentially suggested a social economic problem. Consumers that could not afford higher price internet might not be able to afford at home internet.

Thus, the open access policies do not seem to hinder any ISP investments. Cheaper networks and higher penetration rates tend to correspond to higher network speeds. We conclude that there is evidence for beneficial effects of open access policies.
